 ...
 * TODO(pmoor): Javadoc
 */
public class RealPieceAnnounceStrategy implements PieceAnnounceStrategy {

  private final TorrentDownload download;

  public RealPieceAnnounceStrategy(TorrentDownload download) {
    this.download = download;
  }

  public BitField getBitFieldToSend() {
    return download.getPieceManager().getValidPieces();
  }
